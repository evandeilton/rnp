...
- estatistica:
  ...
  Funcao `function(x) ...` da estatistica de interesse.

- B:

  Inteiro. Numero de replicas.
...
Uma lista com `replicas` e `resumo` (tibble).
