...
Testa a aleatoriedade de uma sequencia pela contagem de sequencias
(runs) acima/abaixo da mediana, com aproximacao normal.

## Usage

``` r
rnp_teste_runs(x, digits = 4L)
```
...
tibble com `runs`, `esperado`, `z`, `p_valor`.
